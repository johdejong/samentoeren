    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-9 col-lg-6">
            <table style="height: 100px;">
                <tbody>
                    <tr>
                        <td class="align-bottom"><img src="{{ asset('storage/icons/logo samen toeren.svg') }}" width="80" class="img-fluid" alt="samen toeren"></td>
                        <td class="align-bottom"><h3 class="text-center mb-4">{{ trans('backpack::base.reset_password') }}</h3></td>
                    </tr>
                </tbody>
            </table>
